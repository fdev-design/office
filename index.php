				...
				<div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-6 m-b30 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
							<div class="dlab-box service-box-2">
								<div class="dlab-media radius-sm dlab-img-overlay1 dlab-img-effect rotate"> 
									<a href="seamless-pipes-tubes.php"><img src="images/products/seamless-pipes-tubes.jpg" alt="Seamless Pipes and Tubes"></a> 
								</div>
								<div class="dlab-info">
									<h4 class="title"><a href="seamless-pipes-tubes.php">Seamless Pipes / Tubes</a></h4>
									<p>Stainless Steel, Carbon Steel, Alloy Steel, High Nickel Alloy Seamless Tubular products.</p>
									<a href="seamless-pipes-tubes.php" class="site-button btnhover14">View Details</a>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 col-sm-6 m-b30 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
							<div class="dlab-box service-box-2">
								<div class="dlab-media radius-sm dlab-img-overlay1 dlab-img-effect rotate"> 
									<a href="welded-pipes-tubes.php"><img src="images/products/welded-pipes-tubes.jpg" alt="Welded Pipes and Tubes"></a> 
								</div>
								<div class="dlab-info">
									<h4 class="title"><a href="welded-pipes-tubes.php">Welded Pipes / Tubes</a></h4>
									<p>Stainless Steel, Carbon Steel, Alloy Steel, High Nickel Alloy Welded Tubular products.</p>
									<a href="welded-pipes-tubes.php" class="site-button btnhover14">View Details</a> 
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 col-sm-6 m-b30 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.9s">
							<div class="dlab-box service-box-2">
								<div class="dlab-media radius-sm dlab-img-overlay1 dlab-img-effect rotate"> 
									<a href="capillary-tubes.php"><img src="images/products/capillary-tubes.jpg" alt="Capillary Tubes"></a> 
								</div>
								<div class="dlab-info">
									<h4 class="title"><a href="capillary-tubes.php">Capillary Tubes</a></h4>
									<p>Manufacturing Stainless Steel, Inconel, Incoloy Capillary Tubes.</p>
									<a href="capillary-tubes.php" class="site-button btnhover14">View Details</a>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 col-sm-6 m-b30 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.3s">
							<div class="dlab-box service-box-2">
								<div class="dlab-media radius-sm dlab-img-overlay1 dlab-img-effect rotate"> 
									<a href="coil-tubes.php"><img src="images/products/coiled-tubes.jpg" alt="Coiled Tubes"></a> 
								</div>
								<div class="dlab-info">
									<h4 class="title"><a href="coil-tubes.php">Coiled Tubes</a></h4>
									<p>Stainless steel, Inconel, Incoloy, Monel, Hastelloy Coiled Tubes</p>
									<a href="coil-tubes.php" class="site-button btnhover14">View Details</a>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 col-sm-6 m-b30 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
							<div class="dlab-box service-box-2">
								<div class="dlab-media radius-sm dlab-img-overlay1 dlab-img-effect rotate"> 
									<a href="buttweld-fittings.php"><img src="images/products/buttweld-fittings.jpg" alt="Buttweld Fittings"></a> 
								</div>
								<div class="dlab-info">
									<h4 class="title"><a href="buttweld-fittings.php">Buttweld Pipe Fittings</a></h4>
									<p>Stainless Steel, Carbon Steel, Alloy Steel, High Nickel Alloy Buttweld Fittings.</p>
									<a href="buttweld-fittings.php" class="site-button btnhover14">View Details</a>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 col-sm-6 m-b30 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.9s">
							<div class="dlab-box service-box-2">
								<div class="dlab-media radius-sm dlab-img-overlay1 dlab-img-effect rotate"> 
									<a href="flanges.php"><img src="images/products/flanges.jpg" alt="Flanges"></a> 
								</div>
								<div class="dlab-info">
									<h4 class="title"><a href="flanges.php">Flanges</a></h4>
									<p>Stainless Steel, Carbon Steel, Alloy Steel, High Nickel Alloys Flanges.</p>
									<a href="flanges.php" class="site-button btnhover14">View Details</a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="section-full content-inner bg-white wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
				<div class="container">
					...
					<div class="blog-carousel owl-carousel owl-btn-3 owl-btn-center-lr">
						...
						<div class="item">
							<div class="blog-post blog-grid blog-rounded blog-effect1">
								<div class="dlab-post-media dlab-img-effect rotate"> <a href="ibr-pipes-tubes-specifications.php"><img src="images/blog/ibr-pipe-tubes.jpg" alt="IBR Pipes and Tubes"></a> </div>
								<div class="dlab-info p-a20 border-1">
                                    <div class="dlab-post-meta ">
                                        <ul>
											<li class="post-author"> By <a href="javascript:void(0);">Prime Tube Impex</a> </li>
									...
									<div class="dlab-post-title">
                                        <h4 class="post-title"><a href="ibr-pipes-tubes-specifications.php">IBR Pipes and Tubes Specifications</a></h4>
                                    </div>
                                    <div class="dlab-post-text">
									</div>
									<div class="dlab-post-readmore"> 
										<a href="ibr-pipes-tubes-specifications.php" title="READ MORE" rel="bookmark" class="site-button btnhover14">READ MORE</a>
									</div>
                                </div>
							</div>
						</div>
			...
			<div class="section-full call-action bg-primary wow fadeIn" data-wow-duration="2s" data-wow-delay="0.1s">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4">
						<img src="images/make-in-india-logo.png" alt="make-in-india-logo">
						</div>
