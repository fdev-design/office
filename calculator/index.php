...
<style type="text/css">
.iws-calc-table{border:1px solid #ececec; padding:10px 20px;}
...
<body>
 ...
 <form name="form1" method="POST" onSubmit="CalculateWeight(); return false;">
  <table class="iws-calc-table" >  
    
    <tr>
      <td><b style="margin-left:.5cm">Material: </b></td>
      <td><select name="product">
          <option>Steel (default)
    ...
    <tr>
      <td><b style="margin-left:.5cm">Shape: </b></td>
      <td><select name="form" onChange="ChangeLabel();ClearFields();showimage();">
          <option selected value="round.jpg">Round
          <option value="square.jpg">Square
          <option value="rectangle.jpg">Rectangle
          <option value="hexagon.jpg">Hexagonal
          <option value="octagon.jpg">Octagonal
          <option value="sheet.jpg">Sheet
          <option value="plate.jpg">Plate
          <option value="tubular.jpg">Tubular
          <option value="ring.jpg">Ring
          <option value="tubular.jpg">Pipe
        </select></td>
    </tr>
    <tr>
      <td height="15"></td>
    ...
    <tr>
      <td align="center" colspan="3"><img src="cal/round.jpg" name="pictures"></td>
    </tr>
    <tr>
      <td height="15"></td>
    </tr>
    <tr>
      <td><b style="margin-left:.5cm">Quantity: </b></td>
      <td><input type="text" name="param4" size="6" maxlength="10">
        </b></font></td>
    </tr>
    <tr>
      <td><input type="text" name="lbl1" size="12" onFocus="if(navigator.appName == 'Netscape'&amp;&amp; parseInt(navigator.appVersion) == 3); else document.forms[0].param1.focus(); " onBlur="ChangeLabel();">
        : </td>
      <td colspan="2"><input type="text" name="param1" size="6" maxlength="10">
        <select name="units1">
          <option>in
          <option>ft
          <option>yd
    ...
    <tr>
      <td><input type="text" name="lbl2" size="12" onFocus="if(!(navigator.appName == 'Netscape' &amp;&amp; parseInt(navigator.appVersion) == 3)){  if(document.forms[0].lbl2.value=='(no value)')  document.forms[0].param3.focus(); else document.forms[0].param2.focus();}">
        : </td>
      <td colspan="2"><input type="text" name="param2" size="6" maxlength="10">
        <select name="units2">
          <option>in
          <option>ft
          <option>yd
    ...
    <tr>
      <td><input type="text" name="lbl3" size="12" onFocus="if(navigator.appName == 'Netscape'&amp;&amp; parseInt(navigator.appVersion) == 3); else document.forms[0].param3.focus(); " onBlur="ChangeLabel();">
        : </td>
      <td colspan="2"><input type="text" name="param3" size="6" maxlength="10">
        <select name="units3">
          <option>in
          <option>ft
          <option>yd
    ...
    <tr>
      <td colspan="3"><input type="submit" name="Submit" value="Calculate" style="margin-left:1cm">
        <input type="reset" name="reset" value="Clear" onClick="ChangeLabel();ClearFields();return false;" style="margin-left:1cm"></td>
    </tr>
    <tr>
      <td height="15"></td>
    </tr>
    ...
    <tr>
      <td colspan="3">Calculated Weight:
        <input type="text" maxlength="8" name="result" size="10" onFocus="if(navigator.appName == 'Netscape'&amp;&amp; parseInt(navigator.appVersion) == 3); else document.forms[0].Submit.focus(); " onBlur="ChangeLabel();">
        Lbs</td>
    </tr>
    <tr>
      <td colspan="3">Calculated Weight:
        <input type="text" maxlength="8" name="result2" size="10" onFocus="if(navigator.appName == 'Netscape'&amp;&amp; parseInt(navigator.appVersion) == 3); else document.forms[0].Submit.focus(); " onBlur="ChangeLabel();">
        Kgs</td>
    </tr>
  </table>
 </form>
 ...
 <script language="JavaScript">
                                    function showimage()
                                            ...
                                            if (!document.images)
                                            return
                                            document.images.pictures.src='cal/'+
